...
import { generatePresignedResumeUploadUrl } from '@/src/server/services/storageService';
...
export async function POST(req: Request) {
  try {
    ...
    const result = await generatePresignedResumeUploadUrl(session.user.id, mimeType, contentLength);
